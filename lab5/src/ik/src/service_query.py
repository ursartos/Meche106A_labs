...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        request.ik_request.pose_stamped.pose.position.x = input("x pos ")
        request.ik_request.pose_stamped.pose.position.y = input("y pos ")
        request.ik_request.pose_stamped.pose.position.z = input("z pos ")
