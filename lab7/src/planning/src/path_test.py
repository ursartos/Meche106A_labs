...
def main():
    ...
    # pos_box = PoseStamped()
    # pos_box.header.frame_id = "base"
    # pos_box.pose.position.x = 0.5
    # pos_box.pose.position.y = 0.0
    # pos_box.pose.position.z = 0.0

    # pos_box.pose.orientation.x = 0.0
    # pos_box.pose.orientation.y = 0.0
    # pos_box.pose.orientation.z = 0.0
    # pos_box.pose.orientation.w = 1.0

    # planner.add_box_obstacle(size, "chonk", pos_box)

    # size = np.array([0.4, 0.1, 1])
    # pos_box = PoseStamped()
    # pos_box.header.frame_id = "base"
    # pos_box.pose.position.x = 0.5
    # pos_box.pose.position.y = -1
    # pos_box.pose.position.z = 0.0
    ...
    # planner.add_box_obstacle(size, "chonker", pos_box)
    ...
    while not rospy.is_shutdown():
        ...
        while not rospy.is_shutdown():
            try:
                ...
                if not controller.execute_path(plan, timeout=10000):
                    raise Exception("Execution failed")
